...
const VideoCard: React.FC<VideoCardProps> = ({ video, onDownload }) => {
  ...
  // State to track if there is an error in previewing the video
  const [previewError, setPreviewError] = useState(false);

  // Function to get the thumbnail URL for the video
  ...
  // Function to get the preview video URL
  ...
  // Reset the preview error state when the hover state changes
  useEffect(() => {
